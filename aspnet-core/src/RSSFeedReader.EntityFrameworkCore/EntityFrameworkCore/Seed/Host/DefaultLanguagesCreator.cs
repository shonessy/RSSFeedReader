...
namespace RssFeedReader.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = RSSFeedReaderConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(RSSFeedReaderDbContext context)
        {
            _context = context;
        }
